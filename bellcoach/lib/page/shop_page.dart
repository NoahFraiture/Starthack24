                ...
                child: ListView(
                  children: [
                    for (Item item in Shop.items)
                      if (item.check(UserCustom.coachLvl)) 
                        sellInfo(item)
                  ],
                ),
              ),
  ...
  return Padding(
    ...
    child: Row(
      children: [
        ...
        const Spacer(),
        const SizedBox(width: 10.0),
        const IconButton(onPressed: Shop.buy, icon: Icon(Icons.monetization_on))
      ],
    ),
  );
}
...
class Shop {
  ...
  static List<Item> items = [
    Item("../../assets/duolingo.png", "Credit Boost", 50, (int a) {return true;}, (){}),
    Item("../../assets/duolingo.png", "Special Badge", 300, (int b) {return true;}, (){}),
    Item("../../assets/bellgroup.png", "Change Coach Gender", 100, (int a){return true;}, () {
        if (UserCustom.coachGender == Gender.boy){ UserCustom.coachGender = Gender.girl;}
        else {{ UserCustom.coachGender = Gender.boy;}}
      }),
  ...
  static void buy(){
    ...
    bool test = item.check(UserCustom.coachLvl);
    if (test){
